(* Human-run heavy M2 script for B02_compton; generated at 2026-08-12T22:06:31.565733+08:00. *)
...
status = Check[
  ...
  Put[<|"benchmark" -> "B02_compton", "process" -> "b02_compton", "status" -> "DONE"|>, FileNameJoin[{outputDir, "compute_m2_report.m"}]];
